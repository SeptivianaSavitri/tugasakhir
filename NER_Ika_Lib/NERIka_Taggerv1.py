...
#coding: utf8
from ner_ikav1 import makeExpandedDBpediaDictionary, listToString, getArticleType, writeListToFile, makeOriginalDBpediaDictionary
...
folder = "data-v1/training/"
inputfile = folder + "prep/ID_formatted1k.txt"

# set the output file

outputfile = folder + "ready/ID_tagged1k_buikav10405-2expanded.txt"
