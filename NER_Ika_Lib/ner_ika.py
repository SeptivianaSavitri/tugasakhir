...
def makeExpandedDBpediaDictionary():
    ...
    person = open("dbpedia/expanded/Person_expanded.txt", "r")
    place = open("dbpedia/expanded/Place_expanded.txt", "r")
    org = open("dbpedia/expanded/ORG_expanded.txt", "r")
...
def makeOriginalDBpediaDictionary():
    ...
    person = open("dbpedia/original/person.txt", "r")
    place = open("dbpedia/original/place.txt", "r")
    org = open("dbpedia/original/organisasi.txt", "r")
