...
def makeExpandedDBpediaDictionary():
    ...
    person = open("dbpedia-v1/expanded/Person_expanded.txt", "r")
    place = open("dbpedia-v1/expanded/Place_expanded.txt", "r")
    org = open("dbpedia-v1/expanded/ORG_expanded.txt", "r")
...
def makeOriginalDBpediaDictionary():
    ...
    person = open("dbpedia-v1/original/person.txt", "r")
    place = open("dbpedia-v1/original/place.txt", "r")
    org = open("dbpedia-v1/original/organisasi.txt", "r")
